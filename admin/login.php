...
<?php ob_start();
    session_start();
      ...
      if(!$conn){
          die("Error with mysqli in login.php");
      }

      try{
          $db = new PDO('mysql:dbhost=localhost;dbname=aryamarga;charset=utf8','root','psonu513@');


      }
      catch(Exception $e){

          die('PDO error in login.php');
      }
              ...
              if($stmt = mysqli_prepare($conn, $sql)){
                  ...
                  if(mysqli_stmt_execute($stmt)){
                      ...
                      if(mysqli_stmt_num_rows($stmt) == 1){
                          ...
                          //changing the password for now from $hashed_password to $password
